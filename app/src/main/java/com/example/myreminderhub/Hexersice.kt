...
import com.example.myreminderhub.databinding.ActivityHexersiceBinding
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase
import java.util.*

class Hexersice : AppCompatActivity() {
    private lateinit var binding: ActivityHexersiceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHexersiceBinding.inflate(layoutInflater)
        ...
        binding.hexersiceaddbtn.setOnClickListener {
    ...
    private fun scheduleNotification() {
        ...
        val title = binding.hexersicetitle.text.toString()
    ...
    private fun showAlert(time: Long, title: String) {
        ...
        database.child(title).setValue(Birthdays).addOnSuccessListener {
            binding.hexersicetitle.text?.clear()
